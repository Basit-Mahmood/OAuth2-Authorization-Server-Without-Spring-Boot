package pk.training.basit.configuration.oauth2.server.authorization;
...
import pk.training.basit.configuration.oauth2.server.authorization.jose.Jwks;
import pk.training.basit.configuration.oauth2.server.authorization.registered.client.OAuth2RegisteredClientMarker;
import pk.training.basit.configuration.oauth2.server.authorization.token.OAuth2TokenMarker;
...
import pk.training.basit.oauth2.server.authorization.authentication.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import pk.training.basit.oauth2.server.authorization.authentication.OAuth2ResourceOwnerPasswordAuthenticationProvider;
...
import pk.training.basit.oauth2.server.authorization.customizer.jwt.impl.JwtCustomizerImpl;
import pk.training.basit.oauth2.server.authorization.customizer.token.claims.OAuth2TokenClaimsCustomizer;
import pk.training.basit.oauth2.server.authorization.customizer.token.claims.impl.OAuth2TokenClaimsCustomizerImpl;

@Configuration(proxyBeanMethods = false)
@ComponentScan(
    basePackageClasses = {OAuth2TokenMarker.class, OAuth2RegisteredClientMarker.class}
)
@PropertySource("classpath:oauth2-authorization-server.properties")
